...
import com.sumit.fasterVpn2021.Config;
import com.sumit.fasterVpn2021.MainApplication;
import com.sumit.fasterVpn2021.adapter.PrefManager;
import com.sumit.fasterVpn2021.fragments.ServersFragment;
import com.sumit.fasterVpn2021.utils.Converter;
...
import static com.sumit.fasterVpn2021.Config.servers_subscription;
...
public abstract class UIActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void VideoAdclass(){
        ...
        IronSource.init(this , "11a3f3475" , IronSource.AD_UNIT.REWARDED_VIDEO);
        ...
        LinearLayout go_pro = findViewById(R. id.go_pro);
        go_pro.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void success(@NonNull Boolean aBoolean) {
                ...
                if (aBoolean) {
                    ...
                    new MaterialDialog.Builder(UIActivity.this)
                            .title("Confirmation")
                            .message("Are You Sure to Disconnect The FasterVPN2021")

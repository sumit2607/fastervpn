...
import com.sumit.fasterVpn2021.dialog.RegionChooserDialog;
...
public class MainActivity extends UIActivity implements TrafficListener, VpnStateListener, ServersFragment.RegionChooserInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IronSource.init(this, "11a3f3475", IronSource.AD_UNIT.BANNER);
        final FrameLayout bannerContainer = findViewById(R.id.fl_adplaceholder);
        IronSourceBannerLayout banner = IronSource.createBanner(this, ISBannerSize.BANNER);
        //IronSourceBannerLayout banner = IronSource.createBanner(this, new ISBannerSize(320, 250));
